...
void setup()
{
  ...
  //Setup LoRa device
  //***************************************************************************************************
  LT.setPacketType(PACKET_TYPE_GFSK);                //set the packet type
  LT.writeRegister(REG_DETECTOPTIMIZE, 0x40);    //set packet mode
  LT.setRfFrequency(Frequency, Offset);
  LT.writeRegister(REG_FDEVLSB, 0x52);       //set deviation (5kHz default)
  LT.writeRegister(REG_LRTEST30, 0x09);  //set the packet config (CCITT CRC, No Address, Yes calculate and append CRC, Normal NRZ encoding, variable length)
  //***************************************************************************************************
